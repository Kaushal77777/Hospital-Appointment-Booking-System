<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="Client.Status" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <header class="jumbotron" style="background-color:#ff1a66;">
            <h1 class="text-center display-3" id="title"> For you For your family For life </h1>
            <div class="container">
            ...
            <div class="form-group d-flex">
                <table class="auto-style2 form-group d-flex">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="timedb" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">
